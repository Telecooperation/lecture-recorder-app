    ...
    public sealed class CaptureFrameWait : IDisposable
    {
        ...
        public SurfaceWithInfo WaitForNewFrame()
        {
            ...
            using (var sourceTexture = Direct3D11Helpers.CreateSharpDXTexture2D(_currentFrame.Surface))
            {
                ...
                {
                    var width = Helper.Clamp(_currentFrame.ContentSize.Width, 0, _currentFrame.Surface.Description.Width);
                    var height = Helper.Clamp(_currentFrame.ContentSize.Height, 0, _currentFrame.Surface.Description.Height);
